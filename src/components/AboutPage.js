          ...
          <div className="space-y-4">
            ...
            <div className="about-content text-left"> {/* Left align the content */}
              ...
              <p>
                ...
                technologists committed to revolutionizing the way Universal
                Health Records (UHR) are managed. Our mission is to provide a
                secure, efficient, and user-friendly platform for managing EHR.
              </p>

              <h2>What We Do</h2>
              <p>
                Our UHR management system provides a comprehensive solution for
